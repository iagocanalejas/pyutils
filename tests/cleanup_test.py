...
class TestCleanup(unittest.TestCase):
    ...
    def test_whitespaces_clean(self):
        values = [
    ...
    def test_remove_parenthesis_preserve_content(self):
        values = [
            ("Hello (world)", "Hello world"),
    ...
    def test_remove_brackets_preserve_content(self):
        values = [
            ("Hello {world}", "Hello world"),
            ("Keep {this} and remove {that}", "Keep this and remove that"),
            ("Nested {example {inner} text}", "Nested example inner text"),
    ...
    def test_remove_symbols_preserve_quotes(self):
        # fmt: off
